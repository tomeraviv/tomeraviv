...
function GitHubIcon()
{
	return <svg version="1.1" viewBox="0 0 16 16" className="inline-block w-4 h-4 align-text-bottom" aria-hidden="true">
...
/**
 * Renders a floating link to a GitHub repository.
 *
